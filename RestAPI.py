...
data = {
  ...
  'max_count': '50000',
  'status_buckets': '300',
  'search':'search index=_internal sourcetype=splunkd | stats count by component | sort - count'
}
...
with open ("output.csv", "w") as f:
  ...
  csvfile.writerow(["component","count"])
  for item in splunk_base_data['results']:
    csvfile.writerow([item['component'],item['count']])
